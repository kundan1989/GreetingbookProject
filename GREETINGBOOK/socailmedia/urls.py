...
urlpatterns = [
    ...
    path('profile/edit/<int:pk>', views.MyProfileUpdateView.as_view(success_url="/socailmedia/home")),

    path('mypost/create/', views.MyPostCreate.as_view(success_url="/socailmedia/mypost")),
    path('mypost/delete/<int:pk>', views.MyPostDeleteView.as_view(success_url="/socailmedia/mypost")),
