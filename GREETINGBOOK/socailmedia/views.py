...
class HomeView(TemplateView):
    template_name = "socailmedia/home.html"
...
class AboutView(TemplateView):
    template_name = "socailmedia/about.html"


class ContactView(TemplateView):
    template_name = "socailmedia/contact.html"


def follow(req, pk):
    user = MyProfile.objects.get(pk=pk)
    FollowUser.objects.create(profile=user, followed_by=req.user.myprofile)
    return HttpResponseRedirect(redirect_to="/socailmedia/myprofile")
...
def like(req, pk):
    ...
    return HttpResponseRedirect(redirect_to="/socailmedia/home")
